...
<div id="register_wrapper">
	...
	<div class="panel-body form-group">
		<ul>
			...
			<li class="pull-right">
				<button id='new_item_button' class='btn btn-info btn-sm pull-right modal-dlg' data-btn-new="<?php echo $this->lang->line('common_new') ?>" data-btn-submit="<?php echo $this->lang->line('common_submit') ?>" data-href="<?php echo site_url("items/view"); ?>" title="<?php echo $this->lang->line($controller_name . '_new_item'); ?>">
				...
				?>
					...
					<table class="sales_table_100">
						<tr>
							...
							<td>
								<?php echo form_dropdown('payment_type', $payment_options, $selected_payment_type, array('id' => 'a', 'class' => 'selectpicker show-menu-arrow', 'data-style' => 'btn-default btn-sm', 'data-width' => 'fit', 'disabled' => 'disabled')); ?>
							</td>
						</tr>
						<tr>
...
<script type="text/javascript">
	...
	// Funcion acceso directo por teclado  REFERENICA DE CODIGOS https://css-tricks.com/snippets/javascript/javascript-keycodes/
...
// fin funcion 
		...
		$('#finish_sale_button').click(function() {
			...
			var tipo = <?php echo $this->config->item('tipo'); ?>;

			if (tipo === 1) {
				$('#buttons_form').attr('action', "<?php echo site_url($controller_name . '/complete2'); ?>");
				$('#buttons_form').submit();
			} else {
				if (tipo == 2) {
					...
					Swal.fire({
						...
						cancelButtonText: 'No emitir',
						confirmButtonText: `Emitir Boleta`,
						denyButtonText: `Venta sin Boleta`,
					}).then((result) => {
